...
$changes = git diff --name-only prototypes/index.html prototypes/regime.json prototypes/sector_rotation.json prototypes/stir.json
if ($changes) {
    $timestamp = Get-Date -Format "yyyy-MM-dd HH:mm"
    git add prototypes/index.html prototypes/regime.json prototypes/sector_rotation.json prototypes/stir.json
...
if ($currentBranch -ne "main") {
    git checkout main -- prototypes/index.html prototypes/regime.json prototypes/sector_rotation.json prototypes/stir.json --quiet
}
